...
public class tinyWRAPJNI {
  ...
  public final static native long QoS_getVideoDataReceived(long jarg1, QoS jarg1_);
  public final static native long QoS_getVideoDataLost(long jarg1, QoS jarg1_);
  public final static native long QoS_getVideoDataSended(long jarg1, QoS jarg1_);
  public final static native long QoS_getVideoDataResend(long jarg1, QoS jarg1_);
  ...
  public final static native void ProxyVideoProducer_setEncoderPassthrough(long jarg1, ProxyVideoProducer jarg1_, boolean jarg2);
  public final static native void ProxyVideoProducer_setDecoderPassthrough(long jarg1, ProxyVideoProducer jarg1_, boolean jarg2);
  ...
  public static int SwigDirector_DDebugCallback_OnDebugInfo(DDebugCallback jself, String message) {
    return jself.OnDebugInfo(message);
  }
  public static int SwigDirector_DDebugCallback_OnDebugWarn(DDebugCallback jself, String message) {
    return jself.OnDebugWarn(message);
  }
  public static int SwigDirector_DDebugCallback_OnDebugError(DDebugCallback jself, String message) {
    return jself.OnDebugError(message);
  }
  public static int SwigDirector_DDebugCallback_OnDebugFatal(DDebugCallback jself, String message) {
    return jself.OnDebugFatal(message);
  }
  public static int SwigDirector_T140Callback_ondata(T140Callback jself, long pData) {
    return jself.ondata((pData == 0) ? null : new T140CallbackData(pData, false));
  }
  public static int SwigDirector_ProxyPluginMgrCallback_OnPluginCreated(ProxyPluginMgrCallback jself, java.math.BigInteger id, int type) {
    return jself.OnPluginCreated(id, twrap_proxy_plugin_type_t.swigToEnum(type));
  }
  public static int SwigDirector_ProxyPluginMgrCallback_OnPluginDestroyed(ProxyPluginMgrCallback jself, java.math.BigInteger id, int type) {
    return jself.OnPluginDestroyed(id, twrap_proxy_plugin_type_t.swigToEnum(type));
  }
  public static int SwigDirector_ProxyAudioConsumerCallback_prepare(ProxyAudioConsumerCallback jself, int ptime, int rate, int channels) {
    return jself.prepare(ptime, rate, channels);
  }
  public static int SwigDirector_ProxyAudioConsumerCallback_start(ProxyAudioConsumerCallback jself) {
    return jself.start();
  }
  public static int SwigDirector_ProxyAudioConsumerCallback_pause(ProxyAudioConsumerCallback jself) {
    return jself.pause();
  }
  public static int SwigDirector_ProxyAudioConsumerCallback_stop(ProxyAudioConsumerCallback jself) {
    return jself.stop();
  }
  public static int SwigDirector_ProxyVideoConsumerCallback_prepare(ProxyVideoConsumerCallback jself, int nWidth, int nHeight, int nFps) {
    return jself.prepare(nWidth, nHeight, nFps);
  }
  public static int SwigDirector_ProxyVideoConsumerCallback_consume(ProxyVideoConsumerCallback jself, long frame) {
    return jself.consume((frame == 0) ? null : new ProxyVideoFrame(frame, false));
  }
  public static int SwigDirector_ProxyVideoConsumerCallback_bufferCopied(ProxyVideoConsumerCallback jself, long nCopiedSize, long nAvailableSize) {
    return jself.bufferCopied(nCopiedSize, nAvailableSize);
  }
  public static int SwigDirector_ProxyVideoConsumerCallback_start(ProxyVideoConsumerCallback jself) {
    return jself.start();
  }
  public static int SwigDirector_ProxyVideoConsumerCallback_pause(ProxyVideoConsumerCallback jself) {
    return jself.pause();
  }
  public static int SwigDirector_ProxyVideoConsumerCallback_stop(ProxyVideoConsumerCallback jself) {
    return jself.stop();
  }
  public static int SwigDirector_ProxyAudioProducerCallback_prepare(ProxyAudioProducerCallback jself, int ptime, int rate, int channels) {
    return jself.prepare(ptime, rate, channels);
  }
  public static int SwigDirector_ProxyAudioProducerCallback_start(ProxyAudioProducerCallback jself) {
    return jself.start();
  }
  public static int SwigDirector_ProxyAudioProducerCallback_pause(ProxyAudioProducerCallback jself) {
    return jself.pause();
  }
  public static int SwigDirector_ProxyAudioProducerCallback_stop(ProxyAudioProducerCallback jself) {
    return jself.stop();
  }
  public static int SwigDirector_ProxyAudioProducerCallback_fillPushBuffer(ProxyAudioProducerCallback jself) {
    return jself.fillPushBuffer();
  }
  public static int SwigDirector_ProxyVideoProducerCallback_prepare(ProxyVideoProducerCallback jself, int width, int height, int fps) {
    return jself.prepare(width, height, fps);
  }
  public static int SwigDirector_ProxyVideoProducerCallback_start(ProxyVideoProducerCallback jself) {
    return jself.start();
  }
  public static int SwigDirector_ProxyVideoProducerCallback_pause(ProxyVideoProducerCallback jself) {
    return jself.pause();
  }
  public static int SwigDirector_ProxyVideoProducerCallback_stop(ProxyVideoProducerCallback jself) {
    return jself.stop();
  }
  public static int SwigDirector_SipCallback_OnDialogEvent(SipCallback jself, long e) {
    return jself.OnDialogEvent((e == 0) ? null : new DialogEvent(e, false));
  }
  public static int SwigDirector_SipCallback_OnStackEvent(SipCallback jself, long e) {
    return jself.OnStackEvent((e == 0) ? null : new StackEvent(e, false));
  }
  public static int SwigDirector_SipCallback_OnInviteEvent(SipCallback jself, long e) {
    return jself.OnInviteEvent((e == 0) ? null : new InviteEvent(e, false));
  }
  public static int SwigDirector_SipCallback_OnMessagingEvent(SipCallback jself, long e) {
    return jself.OnMessagingEvent((e == 0) ? null : new MessagingEvent(e, false));
  }
  public static int SwigDirector_SipCallback_OnInfoEvent(SipCallback jself, long e) {
    return jself.OnInfoEvent((e == 0) ? null : new InfoEvent(e, false));
  }
  public static int SwigDirector_SipCallback_OnOptionsEvent(SipCallback jself, long e) {
    return jself.OnOptionsEvent((e == 0) ? null : new OptionsEvent(e, false));
  }
  public static int SwigDirector_SipCallback_OnPublicationEvent(SipCallback jself, long e) {
    return jself.OnPublicationEvent((e == 0) ? null : new PublicationEvent(e, false));
  }
  public static int SwigDirector_SipCallback_OnRegistrationEvent(SipCallback jself, long e) {
    return jself.OnRegistrationEvent((e == 0) ? null : new RegistrationEvent(e, false));
  }
  public static int SwigDirector_SipCallback_OnSubscriptionEvent(SipCallback jself, long e) {
    return jself.OnSubscriptionEvent((e == 0) ? null : new SubscriptionEvent(e, false));
  }
  public static int SwigDirector_XcapCallback_onEvent(XcapCallback jself, long e) {
    return jself.onEvent((e == 0) ? null : new XcapEvent(e, false));
  }
  public static int SwigDirector_MsrpCallback_OnEvent(MsrpCallback jself, long e) {
    return jself.OnEvent((e == 0) ? null : new MsrpEvent(e, false));
  }
