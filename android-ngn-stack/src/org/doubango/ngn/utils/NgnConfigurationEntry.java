...
//	//https://sip.webrtc.group/rtcModeil1
//    public static final String SIP_HOST_IP  = "49.232.24.193";
//    public static final int    SIP_PORT     = 27060;
//    public static final String SIP_ACCOUNT  = "813";
//    public static final String SIP_PASSWORD = "123456";

//    //https://119.45.122.93/webrtc/
//    public static final String SIP_HOST_IP  = "119.45.122.93";
//    public static final int    SIP_PORT     = 27060;
//    public static final String SIP_ACCOUNT  = "1001";
//    public static final String SIP_PASSWORD = "1234";

    //https://192.168.1.111/test.html
    public static final String SIP_HOST_IP  = "192.168.1.111";
    public static final int    SIP_PORT     = 5060;
    public static final String SIP_ACCOUNT  = "1001";
    public static final String SIP_PASSWORD = "4321";
	...
	public static final String  DEFAULT_NETWORK_REALM           = SIP_HOST_IP;
	...
	public static final String  DEFAULT_NETWORK_PCSCF_HOST      = DEFAULT_NETWORK_REALM;
	public static final int     DEFAULT_NETWORK_PCSCF_PORT      = SIP_PORT;
	...
	//	Identity
    public static final String  DEFAULT_IDENTITY_DISPLAY_NAME   = SIP_ACCOUNT;
	public static final String  DEFAULT_IDENTITY_IMPI           = DEFAULT_IDENTITY_DISPLAY_NAME;
	public static final String  DEFAULT_IDENTITY_IMPU           = "sip:"+DEFAULT_IDENTITY_IMPI+"@"+DEFAULT_NETWORK_PCSCF_HOST;
	public static final String  DEFAULT_IDENTITY_PASSWORD       = SIP_PASSWORD;
    ...
    public static final String  DEFAULT_QOS_PREF_VIDEO_SIZE          = tmedia_pref_video_size_t.tmedia_pref_video_size_360p.toString();
